...
const url = "https://real-esstate.herokuapp.com/property/";
 //const url = "http://localhost:3003/property/";
    ...
    <>
      <div className="datatable-container">
        <div className="heading">
          ...
          <div className="table-heading contact">Contact</div>
          ...
          <div className="table-heading days">Days Left</div>
        ...
        {/* <table>
          <thead>
            <tr>
              <th className="table-head ppdid" id="ppdigd">
                PPD ID
              </th>
